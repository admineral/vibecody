      ...
      <header className="h-14 border-b border-gray-300 flex items-center px-4 bg-gray-900 text-white">
        ...
        <div className="ml-auto flex items-center space-x-2">
          ...
          <div className="flex items-center gap-1 ml-2">
            <Link 
              href="/3d-card"
              className="flex items-center gap-1 px-2 py-0.5 h-7 rounded bg-gray-800 hover:bg-blue-600 text-white text-[11px] font-medium transition-colors shadow-sm"
            >
            ...
            >
              <svg className="w-3.5 h-3.5 mr-1" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                ...
                <path d="M7 7h10v10H7z" stroke="currentColor" strokeWidth="2" fill="none" />
              </svg>
              3D Sandbox
            </Link>
            <Link 
            ...
            >
              <svg className="w-3.5 h-3.5 mr-1" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M3 7v13h18V7M3 7l9-4 9 4" />
                <rect x="7" y="10" width="10" height="6" rx="1" stroke="currentColor" strokeWidth="2" fill="none" />
              </svg>
              3D File Tree
            </Link>
          </div>
